% It calculates the far wake effect of Nt wind turbines (JENSEN), with 
% plotting. Valentín Osuna-Enciso, January,February,March, 2016.
function Vj=JENSEN_NG2(Nt,v0,maxx,maxy,rx,ry,teta)
    % INPUT DATA: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     plot(rx,ry,'b*'), hold on % Turbine positions
    for i1=1:Nt 
...
%         plot([x5,x7],[y5,y7],'k-','linewidth',2) %LADO 2 ESTELA        
    ...
    Xij=zeros(Nt,Nt); rij=Xij; Dij=Xij; Ashadowi=Xij; A0=2*pi*(r0^2);    
...
%                     plot(x,y,'w*','lineWidth',7)                    
    ...
    %%% CALCULUS OF THE VELOCITY ENTERING TO EACH TURBINE:
    Cr=1-sqrt(1-Ct);
