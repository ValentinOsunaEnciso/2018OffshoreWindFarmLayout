function E = DE_14(X,Nt,maxx,maxy)
% Output arguments:
% bestmem              : parameter vector with f_best solution
% EvalFO               : number of function evaluations
% Run DE minimization; strategy: DE/current-to-best/1 ;  ui = popold + F*(bm-popold) + F*(pm1 - pm2);
    rng('shuffle');
    Np=30; %Nt=46; 
    D=Nt*2; F=0.84; Cr=0.15; 
    maxIter=200; k = 0;
...
%     figure
%     plot(best(1,1:Nt),best(1,Nt+1:end),'bs','LineWidth',3)
%     grid on
%     figure
%     plot(CONVERGE)
